...
var ComponentGridComponent = function ComponentGridComponent(props) {
    ...
    var rowsContainerStyle = props.rowsContainerStyle;
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(_gridBody2.default, { data: data, columns: columns, rowClickHandler: rowClickHandler, style: rowsContainerStyle })
    );
};
