...
var GridRowComponent = function (_React$Component) {
    ...
    function GridRowComponent(props) {
        ...
        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(GridRowComponent).call(this, props));
    ...
    _createClass(GridRowComponent, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                'div',
                { className: this.props.rowClass, style: { display: 'flex' }, onClick: this._onClick },
                this.props.children
            );
        }
    }]);
