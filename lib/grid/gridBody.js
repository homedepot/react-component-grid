...
var createRow = function createRow(item, tableColumns, rowClickHandler, rowHeader, rowFooter, useDefaultStyle) {
...
var renderGridMap = function renderGridMap(oldRows, oldData, newData, columns, rowClickHandler, rowHeader, rowFooter, useDefaultStyle) {
...
var GridBodyComponent = function (_React$Component) {
    ...
    _createClass(GridBodyComponent, [{
        ...
        value: function componentWillMount() {
            ...
            var rowHeader = _props.rowHeader;
            var rowFooter = _props.rowFooter;
            var useDefaultStyle = _props.useDefaultStyle;

            var tableRows = renderGridMap(null, null, data, columns, rowClickHandler, rowHeader, rowFooter, useDefaultStyle);
            this.setState({
                tableRows: tableRows
            });
        }
        ...
        value: function componentWillReceiveProps(nextProps) {
            ...
            var rowHeader = nextProps.rowHeader;
            var rowFooter = nextProps.rowFooter;
            var useDefaultStyle = nextProps.useDefaultStyle;

            if (!(0, _isEqual2.default)(this.props, nextProps)) {
                var tableRows = renderGridMap(this.state.tableRows, this.props.data, data, columns, rowClickHandler, rowHeader, rowFooter, useDefaultStyle);
                this.setState({
                    tableRows: tableRows
                });
            }
